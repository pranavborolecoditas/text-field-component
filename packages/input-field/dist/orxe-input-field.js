...
let OrxeInputField = class OrxeInputField extends LitElement {
    constructor() {
        super();
    ...
    render() {
      ...
      <div class="container">
        <div class="${className}">
          ...
          <label class="body--r">${this.fieldDisplayName}</label>
...
OrxeInputField.styles = styles;
OrxeInputField = __decorate([
    customElement('orxe-input-field'),
    __metadata("design:paramtypes", [])
], OrxeInputField);
export default OrxeInputField;
